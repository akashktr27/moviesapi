...
SECRET_KEY = 'django-insecure-ov_x18y+o11x-9&qz*=fv2xr+lj9jh@i&)n$=5%x1u=4w!&lp*'
...
MIDDLEWARE = [
    ...
    'playlist.middleware.RequestMiddleware'
]
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_GRACE_PERIOD': timedelta(seconds=30),
    'SLIDING_TOKEN_REFRESH_EXP_CLAIM': True,
    'SLIDING_TOKEN_USER_ID_CLAIM': 'id',
    'SLIDING_TOKEN_ALGORITHM': 'HS256',
    'SLIDING_TOKEN_AUTH_HEADER_PREFIX': 'Bearer',
}

AUTH_USER_MODEL = "playlist.CustomUser"
